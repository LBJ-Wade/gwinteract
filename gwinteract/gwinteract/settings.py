"""
Django settings for gwinteract project.
...
ALLOWED_HOSTS = ['127.0.0.1', 'gwsci.ciera.northwestern.edu']
...
WSGI_APPLICATION = 'gwinteract.wsgi.application'
